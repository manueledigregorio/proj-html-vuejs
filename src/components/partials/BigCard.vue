...
<template>
  ...
  <div class="cards ">
    <div class="hover-container">
      <div>
      <img class="img-hover" :src="items.img" alt="" />
    </div>
    ...
    <div class="hover-text d-flex flex-column">
        <div class="link">
          <a :href="items.href">
            <i class=" d-flex justify-content-center align-items-center " :class="items.link"></i>
          </a>
        </div>
        {{ items.title }}
    </div>
    ...
    <div class="p-4">
        <h4 class="font">{{ items.title }}</h4>
        <p class=" p-2 ">{{ items.subtitle }}</p>
        <hr>
